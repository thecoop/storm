...
public class JCQueuePerfTest {
    ...
    private static void ackingProducerSimulation() {
        ...
        JCQueue spoutQ = new JCQueue("spoutQ", 1024, 0, true, 100, ws, "test", "test", 1000, 1000, registry);
        JCQueue ackQ = new JCQueue("ackQ", 1024, 0, true, 100, ws, "test", "test", 1000, 1000, registry);
    ...
    private static void producerFwdConsumer(int prodBatchSz) {
        WaitStrategyPark ws = new WaitStrategyPark(100);
        StormMetricRegistry registry = new StormMetricRegistry();
        JCQueue q1 = new JCQueue("q1", 1024, 0, true, prodBatchSz, ws, "test", "test", 1000, 1000, registry);
        JCQueue q2 = new JCQueue("q2", 1024, 0, true, prodBatchSz, ws, "test", "test", 1000, 1000, registry);
    ...
    private static void oneProducer1Consumer(int prodBatchSz) {
        JCQueue q1 = new JCQueue("q1", 50_000, 0, true, prodBatchSz, new WaitStrategyPark(100), "test", "test", 1000, 1000,
